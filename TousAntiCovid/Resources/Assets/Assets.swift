...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let gradientEndOrange = ColorAsset(name: "gradientEndOrange")
    ...
    internal static let gradientStartOrange = ColorAsset(name: "gradientStartOrange")
    ...
    internal static let notificationWarningButtonBackground = ColorAsset(name: "notificationWarningButtonBackground")
    ...
    internal static let privateEventSeparator = ColorAsset(name: "privateEventSeparator")
